...
set -euo pipefail  # detener si algo falla
...
if [[ ! -f "$PROJECT_ROOT/.env" ]]; then
    echo "[INFO] Creando archivo .env desde .env.example en raíz..."
...
echo "  - Tests:       docker compose -f $COMPOSE_FILE exec backend python manage.py test"
echo
