    ...
    Asistiendo a la ciencia desde 1952
      ...
      <div className="container mx-auto px-4 py-20 max-w-5xl">
        <div className="space-y-6 text-lg text-muted-foreground">
          <p>
            Somos una empresa especializada en soluciones integrales para laboratorios industriales y de investigación.
            Combinamos asesoramiento técnico, provisión de insumos y equipamiento, y soporte posventa confiable.
          </p>

          <p>
            Nuestra misión es asegurar confiabilidad en todo el proceso de provisión,
            contribuyendo al desarrollo científico, tecnológico y productivo en sectores
            como el farmacéutico, químico, energético, alimenticio, ambiental y de investigación.
          </p>

          <p>
            Acompañamos a nuestros clientes en cada etapa, desde la detección de la necesidad
            hasta la implementación, garantizando eficiencia, seguridad y continuidad operativa.
          </p>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4 max-w-6xl grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground">
              Trabajamos con un firme compromiso con la calidad, operando bajo sistemas
              de gestión certificados que garantizan productos, servicios y procesos confiables.
            </p>

            <p className="text-muted-foreground">
              El cliente es el eje de nuestra organización: escuchamos, acompañamos y
              respondemos con agilidad, priorizando soluciones eficaces y relaciones de largo plazo.
            </p>

            <p className="text-muted-foreground">
              Impulsamos la innovación y la mejora continua, incorporando nuevas tecnologías
              y actuando con responsabilidad, ética y respeto por el entorno.
            </p>
          </div>
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
      ...
      <div className="container mx-auto px-4 py-20 max-w-6xl">
        ...
        <p className="text-center text-muted-foreground mb-10 max-w-3xl mx-auto">
          Representamos fabricantes líderes, acercando al mercado local tecnologías
          y soluciones que cumplen con los más altos estándares de calidad y exigencia global.
        </p>
